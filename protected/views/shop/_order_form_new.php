...
<div class="" >
	...
	<div class="delivery__new">
		<h3 class="desk">Способ доставки:</h3>
		<div class="del__flex">
	...
	<div class="form-block">
		...
		<div class="form-block-content">
			...
			<div class="psevdosubmit"><a href="javascript:void(0);" class="c">Оформить заказ</a></div>
			<input type="submit" class="psevdosubmithide" value="Оформить заказ" style="display:none;">
		...
		$('.check-buyer').change(function() {
			...
			$.each(arrCheck,function(index,value){
				if($self.prop('checked')) {
					//$(value).val('Уточнить у отправителя').prop('readonly', true);
					//$(value).val('Уточнить у отправителя').css({'pointer-events': 'none', 'opacity': '0.5', 'position': 'relative','z-index': '100','color': 'transparent',});
					$(value).val('Уточнить у отправителя').addClass('event-none_order');
				} else {
